...
def presentacion():
    ...
    <html>
        ...
        <body>
            ...
            <p> Visita mi perfil en <a href="https://www.linkedin.com/in/carlos-abimael-gonzalez-975086234/"><img alt="LinkedIn" src="https://img.shields.io/badge/LinkedIn-blue?style=flat-square&logo=linkedin"></a></p>
            <p> El desarrollo de este proyecto esta en <a href="https://github.com/Abimael-Lib/P1_MLOPs_Steam_Games_Render"><img alt="GitHub" src="https://img.shields.io/badge/GitHub-black?style=flat-square&logo=github"></a></p>
        </body>
    </html>
    '''
